...
proc update_PARAM_VALUE.pkt_size { PARAM_VALUE.pkt_size } {
	# Procedure called to update pkt_size when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.pkt_size { PARAM_VALUE.pkt_size } {
	# Procedure called to validate pkt_size
	return true
}
...
proc update_MODELPARAM_VALUE.pkt_size { MODELPARAM_VALUE.pkt_size PARAM_VALUE.pkt_size } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.pkt_size}] ${MODELPARAM_VALUE.pkt_size}
}
