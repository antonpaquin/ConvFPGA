...
proc create_root_design { parentCell } {
  ...
  # Create instance: dataip2_0, and set properties
  set dataip2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dataip2:1.0 dataip2_0 ]
  set_property -dict [ list \
   CONFIG.pkt_size {32} \
 ] $dataip2_0
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins dataip2_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net dataip2_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins dataip2_0/M00_AXIS]
